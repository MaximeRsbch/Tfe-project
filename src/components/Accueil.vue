...
<template>
    <div class="relative overflow-x-hidden">
        ...
        >
            <div
                class="flex flex-col bg-white w-[280px] sm:w-[400px] rounded-md max-h-[64vh] md:max-h-[74vh] lg:max-h-[68vh] overflow-y-auto"
            >
        ...
        <div
            id="map"
            class="z-[1] h-[575px] sm:h-[642px] md:h-[642px] lg:h-[606px] xl:h-[606px]"
        ></div>
    </div>
</template>
