...
import MapSearchSecours from "./MapSearchSecours.vue";
...
async function createSecour() {
    Swal.fire({
        title: "Êtes-vous sûr?",
        text: "Vous êtes sur le point d'ajouter un poste de secour!",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        confirmButtonText: "Oui, ajouter le poste de secour!",
    }).then((result) => {
        if (result.isConfirmed) {
            parcsStore.createSecours(
                latitude.value,
                longitude.value,
                id_parc.value
            );
    ...
    <div class="pt-10 pb-10">
        ...
        >
            ...
            <h2 class="text-lg font-semibold text-gray-700 pt-4">
                Ajout d'un poste de secour
            </h2>

            <form @submit.prevent="createSecour">
