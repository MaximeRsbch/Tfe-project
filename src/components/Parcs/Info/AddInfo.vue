...
import MapSearchInfo from "./MapSearchInfo.vue";
...
async function createInfo() {
    Swal.fire({
        title: "Êtes-vous sûr?",
        text: "Vous êtes sur le point d'ajouter un point d'information!",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        confirmButtonText: "Oui, ajouter le point d'information!",
    }).then((result) => {
        if (result.isConfirmed) {
            parcsStore.createInfos(
                latitude.value,
                longitude.value,
                id_parc.value
            );
    ...
    <div class="pt-10 pb-10">
        ...
        >
            ...
            <h2 class="text-lg font-semibold text-gray-700 pt-4">
                Ajout d'un point d'information
            </h2>
            ...
            <form @submit.prevent="createInfo">
                ...
                <div class="flex justify-end mt-6">
                    ...
                    >
                        Ajouter le point d'information
                    </button>
                </div>
            </form>
        </section>
